<?php
    ...
    if($filtro==0){
        $sql = "SELECT * FROM wp_solicitations WHERE resultado!='PENDENTE' ORDER BY solicitation_id DESC";
    }else{
        $sql = "SELECT * FROM wp_solicitations WHERE semestre='$filtro' AND resultado!='PENDENTE' ORDER BY solicitation_id DESC";
    }
